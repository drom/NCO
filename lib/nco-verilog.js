...
reg [${2*dataWidth-1}:0] ncolut[0:${Math.pow(2,addrWidth)-1}] = ${lutString};
...
assign ${pre}addr = ${pre}angle[${addrSelect}];
...
assign ${p.i[0].wire}[${dataWidth*2+angleWidth-1}:${dataWidth*2-1}] = ${pre}angle;
`;
            }
        },
        'nco_cordic': {
...
assign ${p.i[0].wire}[${dataWidth*2+angleWidth-1}:${dataWidth*2-1}] = beta_calc;
